...
```text
locale/
├── pt_BR/LC_MESSAGES/django.po   # editable (you translate here)
└── pt_BR/LC_MESSAGES/django.mo   # compiled (generated, don't edit)
```

| Command | What it does |
| --- | --- |
| `makemessages -l pt_BR` | Creates/updates the `.po` for `pt-br` (dir `pt_BR`) |

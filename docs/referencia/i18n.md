...
```text
locale/
├── pt_BR/LC_MESSAGES/django.po   # editável (você traduz aqui)
└── pt_BR/LC_MESSAGES/django.mo   # compilado (gerado, não edite)
```

| Comando | O que faz |
| --- | --- |
| `makemessages -l pt_BR` | Cria/atualiza o `.po` do idioma `pt-br` (dir `pt_BR`) |
